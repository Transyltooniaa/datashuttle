...
html_baseurl = 'https://transyltooniaa.github.io/datashuttle/'
...
html_theme_options = {
    ...
    "json_url": "https://raw.githubusercontent.com/Transyltooniaa/datashuttle/finalTest/docs/source/_static/switcher.json",
